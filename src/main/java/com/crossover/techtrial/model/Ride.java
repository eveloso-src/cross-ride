...
public class Ride implements Serializable {
	...
	public Long getRideTime() {
		LocalDateTime timeStart = LocalDateTime.parse(getStartTime(), DateTimeFormatter.ISO_LOCAL_DATE_TIME);
		LocalDateTime timeEnd = LocalDateTime.parse(getEndTime(), DateTimeFormatter.ISO_LOCAL_DATE_TIME);
		long times = timeStart.toLocalTime().until(timeEnd, java.time.temporal.ChronoUnit.MINUTES);
		return times;
	}
